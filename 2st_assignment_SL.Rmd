...
# ```{r}
# svmFit_spectrum <- train(Bankrupt. ~., method = "svmPoly", 
#                 data = trainSet2,
#                 preProcess = c("center", "scale"),
#                 tuneGrid = expand.grid(C = c(0.1, .25, .5),
#                                         degree =c(5,6,7,8),
#                                        scale=c(1,2)), 
#                 metric = "Kappa",
#                 trControl = ctrl)
# 
# svm_spectrumPred = predict(svmFit_spectrum, testSet2)
# confusionMatrix(svm_spectrumPred,testSet2$Bankrupt.)
# ```
